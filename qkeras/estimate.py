...
def extract_model_operations(in_model):
  ...
  for layer in model.layers:
    ...
    if layer.__class__.__name__ in ["QConv2D"]:
      ...
      # the last dimension of the input and the last dimension of the output determine 
      # the weights, while the other dimensions determine how many times the Dense operation is performed
